...
var html = `
	...
	<div class="snowlord-devConsole-container-body">
		<div class="snowlord-devConsole-container-body-elements hidden">
			<h3 style="border-bottom: 2px solid #000!important;">Elements</h3>
            <div class="snowlord-devConsole-container-body-elements-container" style="white-space: pre!important; width: 100%!important; height: 200px!important; overflow: scroll!important;">
            </div>
		</div>
		...
		<div class="snowlord-devConsole-container-body-console hidden">
			<div class="snowlord-devConsole-container-body-console-text" style="user-select: auto;">
				<div class="snowlord-devConsole-container-body-console-messages">
					<span style="color: #bababa!important; user-select: none;">` + "\u2B9E" + new Date().toLocaleTimeString().split(" ")[0] + ` </span>
					<span style="color: #000!important;">Console has loaded!</span>
				</div>
			</div>
			<div class="snowlord-devConsole-container-body-console-commands">
				<textarea id="snowlord-devConsole-container-body-console-input" placeholder="console.log('Hello World!');" style="resize: horizontal!important; position: sticky!important; width: 100%!important; height: 90%!important; outline: none!important; border: none!important;"></textarea>
			</div>
		</div>
		...
		<div class="snowlord-devConsole-container-body-sources showing">
			<div class="snowlord-devConsole-container-body-sources-scripts" style="padding-left: 10px;">
				<h3 style="border-bottom: 2px solid #000!important;">Page <a class="snowlord-devConsole-container-body-sources-scripts-reload" style="cursor: pointer; color: #0a68ff; user-select: none;">` + "\u21BA" + `</a></h3>
				<div class="snowlord-devConsole-container-body-sources-scripts-container" style="float: left; width: 60%; background-color: #bababa!important;">
				...
				<div class="snowlord-devConsole-container-body-sources-scripts-preview" style="float: left; width: 40 %; background-color: #bababa!important;">
		...
		<div class="snowlord-devConsole-container-body-tools hidden">
			<h3 style="border-bottom: 2px solid #000!important;">Tools</h3>
		...
		<div class="snowlord-devConsole-container-body-settings hidden">
			<h3 style="border-bottom: 2px solid #000!important;">Settings</h3>
		</div>
	</div>
`.trim();
	...
	console.log = function(msg) {
		...
		if (snowlord_variables.hijackFunctions && c) {
            ...
            if (typeof(msg) == "number") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u2705" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #0015ff!important;"> ' + msg +'</span></div>';	
			} else if (typeof(msg) == "string") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u2705" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #000!important"> "</span><span style="color: #1c0000!important;">' + msg +'</span><span style="color: #000!important">"</span></div>';				
			} else if (typeof(msg) == "function") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u2705" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #000!important"> "</span><span style="color: #1c0000!important;">' + msg +'</span><span style="color: #000!important">"</span></div>';								
			} else if (typeof(msg) == "undefined") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u2B9E" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #b5b5b5!important;"> ' + msg +'</span></div>';
			} else {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u2705" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #1c0000!important;"> ' + msg +'</span></div>';
			}
	...
	console.error = function(msg) {
		...
		if (snowlord_variables.hijackFunctions && c) {
			...
			if (snowlord_variables.hideLogs) {
				...
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u274C" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #000!important"> "</span><span style="color: #d10000!important;">' + msg +'</span><span style="color: #000!important">"</span></div>';				
			} else if (typeof(msg) == "function") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u274C" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #000!important"> "</span><span style="color: #d10000!important;">' + msg +'</span><span style="color: #000!important">"</span></div>';								
			} else if (typeof(msg) == "undefined") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u2B9E" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #b5b5b5!important;"> ' + msg +'</span></div>';
			} else {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u274C" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #d10000!important;"> ' + msg +'</span></div>';
			}
			if (c.childElementCount > cHeight) {
				c.children[0].remove();
			}
	...
	console.warn = function(msg) {
		...
		if (snowlord_variables.hijackFunctions && c) {
			...
			if (snowlord_variables.hideLogs) {
				...
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u26A0\uFE0F" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #0015ff!important;"> ' + msg +'</span></div>';	
			} else if (typeof(msg) == "string") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u26A0\uFE0F" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #000!important"> "</span><span style="color: #998201!important;">' + msg +'</span><span style="color: #000!important">"</span></div>';				
			} else if (typeof(msg) == "function") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u26A0\uFE0F" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #000!important"> "</span><span style="color: #998201!important;">' + msg +'</span><span style="color: #000!important">"</span></div>';								
			} else if (typeof(msg) == "undefined") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u2B9E" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #b5b5b5!important;"> ' + msg +'</span></div>';
			} else {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">` + "\u26A0\uFE0F" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #998201!important;"> ' + msg +'</span></div>';
			}
			if (c.childElementCount > cHeight) {
				c.children[0].remove();
			}
...
`.trim();
    ...
    var tooltip = `
	<div id="snowlord-devConsole-tooltip" style="padding: 5px; background-color: #000!important; position: absolute; color: #fff; user-select: none; z-index: 99999999999; border-radius: 10px; ">
...
`.trim();
    ...
    consoleInput.addEventListener("keydown", function (e) {
        if (e.keyCode == 76 && e.ctrlKey && !e.altKey && !e.shiftKey && snowlord_variables.loaded) {
            document.getElementsByClassName("snowlord-devConsole-container-body-console-text")[0].innerHTML = '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #bababa!important; user-select: none;">⮞' + new Date().toLocaleTimeString().split(" ")[0] + ' </span><i style="color: #bababa!important;">Console was cleared</i></div>';
            this.value = '';
        }
